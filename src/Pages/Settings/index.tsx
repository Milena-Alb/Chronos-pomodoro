...
export function Settings() {
    ...
    function handleSaveSettings(e: React.FormEvent<HTMLFormElement>) {
        ...
        if (isNaN(workTime) || isNaN(shortBreakTime) || isNaN(longBreakTime)) {
            formError.push('Por favor usar somente números para todos os campos.');
        }
    ...
    return (
        <MainTemplate>
            ...
            <Container>
                <p style={{ textAlign: 'center' }}>Modifique as cofingurações para tempo de foco, descanso curto e descanso longo.</p>
            </Container>
            <Container>
